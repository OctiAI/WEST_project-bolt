...
const Hero = () => {
  // Dynamically load the Great Lakes form script once
  useEffect(() => {
    const script = document.createElement('script');
    script.src = 'https://link.greatlakesmarketingandsoftwaresolutions.com/js/form_embed.js';
    script.async = true;
  ...
  return (
    <section className="relative min-h-screen flex items-center px-4 sm:px-6 lg:px-8 bg-black text-white">
      ...
      <div className="block lg:hidden absolute top-4 left-0 w-full flex justify-center z-20 px-8">
        <button className="flex justify-center bg-lime-400 hover:bg-lime-500 text-gray-900 px-6 py-3 rounded-lg font-semibold text-base sm:text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg items-center gap-2 sm:gap-3">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 sm:mb-80">
        <div className="mb-0 sm:mb-28 flex justify-center">
          <img
            src="https://images.renovationfind.com/images/4/0/98/6844/westland-electric_logo_1621549730229.png"
            alt="Westland"
            className="pt-4 w-36 sm:w-48 h-auto opacity-90"
          />
        </div>
